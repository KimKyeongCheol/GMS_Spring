  ...
  <div class="col-lg-6" style="width: 500px;margin: 0 auto;">
    <div class="input-group">
      ...
      <span class="input-group-btn">
        <button onclick="app.controller.searchStudent('${search}')" class="btn btn-default" type="button">Go!</button>
      </span>
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
</div><!-- /.row -->
<div style="height: 40px;width:300px;"></div>
	...
	<table id="member_list_tab">
		...
		<tr>
<%-- 			<td><fmt:formatNumber pattern="."  value="${i.num}"></fmt:formatNumber></td> --%>
			<td><fmt:formatNumber pattern="."  value="${i.num}"></fmt:formatNumber></td>
			<td>${i.id}</td>
